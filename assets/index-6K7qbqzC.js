...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:xi,depthTest:!1,depthWrite:!1})}function Zh(){return new Bn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:To(),fragmentShader:`
		...
		`,blending:xi,depthTest:!1,depthWrite:!1})}function Jh(){return new Bn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:To(),fragmentShader:`
