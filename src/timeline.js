...
// --- BLOB STÖSST DIE WÖRTER AUSEINANDER --- //
timeline.to("#three-canvas", {
    scale: 1,
    ease: "circ.out",   // gleiche Ease wie die Wörter → wirkt „verbunden"
    duration: 9,
}, "<")                 // ← startet exakt mit der vertikalen Bewegung
